...
- `TelegramHandler` с помощью бота Telegram отправляет сообщения заданным пользователям или группам. Обратите внимание, данный обработчик по умолчанию не заработает на территории РФ, т.к. сеть для работы с API Telegram заблокирована Роскомнадзором.
